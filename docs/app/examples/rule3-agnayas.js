...
const SRC_A = { x:5.8, y:5.4,  z:-1.6 }; // возвращено к стабильным координатам (были неизменны 9 коммитов подряд,
                                          // включая «×2 тайминг»; последний коммит 10507e1 сократил путь и,
                                          // судя по всему, вызвал наезд AY на AS — см. разбор в чате
