 ...
 * @property {number} [clearanceY] - ЭКСПЕРИМЕНТАЛЬНАЯ альтернатива clearanceZ (подъём вверх на время вращения, складывается с bounceH) — только для живого A/B сравнения, не решённый путь; дефолт 0
